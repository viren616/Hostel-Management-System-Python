...
class Student:
    def __init__(self):
        ...
        side.place(x=0, y=-5)
        load4 = Image.open("E:/prog/qp/sss.png")
        load4= load4.resize((230, 50), Image.ANTIALIAS)
        ...
        l1=Label(side,text='Add Student',font='Algerian  16  ',bg='black',fg='firebrick',cursor='hand2')
        l1.place(x=30,y=150)
        l1.bind('<Button>',AddStud)
        def Remove(event):
            root.destroy()
            Deletestud.Delete()
        l2 = Label(side, text='Remove Student', font='Algerian  16  ', bg='black', fg='firebrick',cursor='hand2')
        l2.place(x=30, y=210)
        l2.bind('<Button>', Remove)

        def Updatestud(event):
            root.destroy()
            Updatefas.Updatefas()
        ...
        l3.place(x=30, y=270)
        l3.bind('<Button>',Updatestud)
        l4 = Label(side, text='Search Student', font='Algerian  16  ', bg='black', fg='firebrick',cursor='hand2')
        l4.place(x=30, y=330)
